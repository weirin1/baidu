...
class LoginConnection
{
     ...
     */
    public function init($url, $uuid = '', $accountType = 1)
    {
        $this->url = $url;
        $this->headers = array('UUID: ' . $uuid, 'account_type: ' . $accountType, 'Content-Type:  data/gzencode and rsa public encrypt;charset=UTF-8');
    }
