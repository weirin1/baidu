    ...
    public function preLogin($userName, $token)
    {
       ...
       // echo '[notice] start preLogin!' . PHP_EOL;
        ...
        if ($preLogin->returnCode === 0) {
          ...
          //  echo '--------------------preLogin End--------------------' . PHP_EOL;
            throw new Exception("[error] preLogin unsuccessfully with return code: {$preLogin->returnCode}");
        }
    }
...
//            echo '--------------------doLogin End--------------------' . PHP_EOL;
//            return null;
            throw new Exception("[error] doLogin unsuccessfully with return code: {$doLogin->returnCode}");
        }
    }
